...
(function(){
  ...
  const PLANS = {
    "4m": {
      ...
      price:"Rp499.000",
      payment:"lynk",
      checkout:"https://lynk.id/taktiksaham/jy46v4g94jqn"
    },
    "6m": {
      label:"VIP 6 Bulan",
      price:"Rp699.000",
      payment:"lynk",
      checkout:"https://lynk.id/taktiksaham/je6yv6jrjvr9"
    },
    "12m": {
      label:"VIP 1 Tahun",
      price:"Rp1.200.000",
      payment:"lynk",
      checkout:"https://lynk.id/taktiksaham/vk3zklnjk1jl"
    },
    "lifetime": {
      label:"VIP Lifetime • Mirae Asset",
      price:"Jalur Mirae Asset",
      payment:"mirae",
      checkout:"https://login.miraeasset.co.id/registration/oe?referralcode=3103248"
    }
  };
  ...
  function pendingHtml(membership){
    ...
    return `<b>Membership masih menunggu aktivasi</b>
      ...
      <a href="${p.checkout}" target="_blank" rel="noopener">BAYAR ${esc(p.label).toUpperCase()} →</a>
      <a href="${LINKS.whatsapp}?text=${encodeURIComponent("Halo Kak Rifqi, saya sudah mendaftar TaktikSaham paket "+p.label+" ("+p.price+") dan ingin konfirmasi pembayaran/aktivasi.")}" target="_blank" rel="noopener">KONFIRMASI WA</a>`;
  }
